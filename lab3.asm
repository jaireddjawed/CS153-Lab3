...
int main() {
  ...
  int numRecursiveTimes[] = {150, 300, 500};
    1005:	be 96 00 00 00       	mov    $0x96,%esi
int main() {
    100a:	53                   	push   %ebx
    100b:	83 e4 f0             	and    $0xfffffff0,%esp
    100e:	83 ec 20             	sub    $0x20,%esp
  int numRecursiveTimes[] = {150, 300, 500};
    1011:	c7 44 24 14 96 00 00 	movl   $0x96,0x14(%esp)
    1018:	00 
    1019:	8d 5c 24 18          	lea    0x18(%esp),%ebx
    101d:	c7 44 24 18 2c 01 00 	movl   $0x12c,0x18(%esp)
    1024:	00 
    1025:	8d 7c 24 20          	lea    0x20(%esp),%edi
    1029:	c7 44 24 1c f4 01 00 	movl   $0x1f4,0x1c(%esp)
    1030:	00 
  int length = 3;
  int i;
  ...
  for (i = 0; i < length; i++) {
    ...
    1031:	89 74 24 08          	mov    %esi,0x8(%esp)
    1035:	c7 44 24 04 d1 17 00 	movl   $0x17d1,0x4(%esp)
    103c:	00 
    103d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1044:	e8 e7 03 00 00       	call   1430 <printf>
    make_recursion(numRecursiveTimes[i]);
    1049:	89 34 24             	mov    %esi,(%esp)
    104c:	e8 2f 00 00 00       	call   1080 <make_recursion>
    printf(1, "\n");
    1051:	c7 44 24 04 e4 17 00 	movl   $0x17e4,0x4(%esp)
    1058:	00 
    1059:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1060:	e8 cb 03 00 00       	call   1430 <printf>
  for (i = 0; i < length; i++) {
    1065:	39 fb                	cmp    %edi,%ebx
    1067:	74 07                	je     1070 <main+0x70>
    1069:	8b 33                	mov    (%ebx),%esi
    106b:	83 c3 04             	add    $0x4,%ebx
    106e:	eb c1                	jmp    1031 <main+0x31>
  }

  exit();
    1070:	e8 5d 02 00 00       	call   12d2 <exit>
...
static int make_recursion(int n) {
  ...
  if (n == 0) {
    ...
    108a:	75 07                	jne    1093 <make_recursion+0x13>
    return 0;
    108c:	b8 00 00 00 00       	mov    $0x0,%eax
    1091:	eb 15                	jmp    10a8 <make_recursion+0x28>
  return n - make_recursion(n - 1);
    1093:	8b 45 08             	mov    0x8(%ebp),%eax
    1096:	83 e8 01             	sub    $0x1,%eax
    1099:	89 04 24             	mov    %eax,(%esp)
    109c:	e8 df ff ff ff       	call   1080 <make_recursion>
    10a1:	8b 55 08             	mov    0x8(%ebp),%edx
    10a4:	29 c2                	sub    %eax,%edx
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13c9:	0f b6 92 ed 17 00 00 	movzbl 0x17ed(%edx),%edx
  }while((x /= base) != 0);
    ...
    143e:	8d 45 10             	lea    0x10(%ebp),%eax
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    155f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
    1561:	b8 e6 17 00 00       	mov    $0x17e6,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1621:	a1 cc 1a 00 00       	mov    0x1acc,%eax
{
  ...
  freep = p;
    1669:	a3 cc 1a 00 00       	mov    %eax,0x1acc
}
    166e:	5b                   	pop    %ebx
    166f:	5e                   	pop    %esi
    1670:	5f                   	pop    %edi
  ...
  freep = p;
    1692:	a3 cc 1a 00 00       	mov    %eax,0x1acc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16bc:	8b 1d cc 1a 00 00    	mov    0x1acc,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16fb:	3b 15 cc 1a 00 00    	cmp    0x1acc,%edx
  ...
  return freep;
    1732:	8b 15 cc 1a 00 00    	mov    0x1acc,%edx
    ...
    1754:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    1757:	89 15 cc 1a 00 00    	mov    %edx,0x1acc
      return (void*)(p + 1);
    ...
    base.s.ptr = freep = prevp = &base;
    176e:	c7 05 cc 1a 00 00 d0 	movl   $0x1ad0,0x1acc
    1775:	1a 00 00 
    base.s.size = 0;
    1778:	ba d0 1a 00 00       	mov    $0x1ad0,%edx
    base.s.ptr = freep = prevp = &base;
    177d:	c7 05 d0 1a 00 00 d0 	movl   $0x1ad0,0x1ad0
    1784:	1a 00 00 
    base.s.size = 0;
    1787:	c7 05 d4 1a 00 00 00 	movl   $0x0,0x1ad4
    178e:	00 00 00 
